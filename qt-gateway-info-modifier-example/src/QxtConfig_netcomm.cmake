...
#        PATH_SUFFIXES ${mod} include/${mod} Qxt/include/${mod} include/Qxt/${mod}
        PATH_SUFFIXES ${mod} QtArm/include/${mod} QtQxtArm/include/${mod}  include/${mod} Qxt/include/${mod} include/Qxt/${mod} include/qxt/${mod}
        PATHS
        /opt/netcomm/
        NO_DEFAULT_PATH
    )
...
#        PATH_SUFFIXES Qxt/lib64 Qxt/lib lib64 lib
        PATH_SUFFIXES QtArm/lib/ QtQxtArm/lib/  Qxt/lib64 Qxt/lib lib64 lib lib/x86_64-linux-gnu
        PATHS
        /opt/netcomm/
        NO_DEFAULT_PATH
    )
...
#        PATH_SUFFIXES Qxt/lib64 Qxt/lib lib64 lib
        PATH_SUFFIXES QtArm/lib/${mod} QtQxtArm/lib/${mod} Qxt/lib64 Qxt/lib lib64 lib lib/x86_64-linux-gnu
        PATHS
        /opt/netcomm/
        NO_DEFAULT_PATH
    )
